...
fourInt.prototype.average = function () {
  return (this.a + this.b + this.c + this.d) / 4;
};

fourInt.prototype.max = function () {
  var max = this.a;
  if (max < this.b)
    max = this.b;
  if (max < this.c)
...
fiveInt.prototype = Object.create(fourInt.prototype);
fiveInt.prototype.constructor = fiveInt;

fiveInt.prototype.squares = function () {
  function square(a, b) {
...
var int = new fourInt(1, 2, 3, 4);
document.write('Parent #1<br>');
document.write("var int = new fourInt(1, 2, 3, 4); <br>");
...
document.write("var int = new fourInt(1); <br>");
int = new fourInt(1);

document.write('Parent #3<br>');
document.write("var int = new fourInt(1, 2, '3', 4); <br>");
int = new fourInt(1, 2, '3', 4);

int = new fiveInt(1, 2, 3, 4, 5);
document.write('Child #1<br>');
document.write("var int = new fiveInt(1, 2, 3, 4, 5); <br>");
document.write("int.a = " + int.a + ' <br>');
document.write("int.b = " + int.b + ' <br>')
document.write("int.c = " + int.c + ' <br>');
document.write("int.d = " + int.d + ' <br>');
...
document.write("var int = new fiveInt(1); <br>");
int = new fiveInt(1);
